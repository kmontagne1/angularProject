...
describe('RaceComponent (Standalone) exo 6', () => {

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [CommonModule, RaceComponent], // Ajouter CommonModule ici
    }).compileComponents();
  });
  ...
  it('should display a race name and its ponies', () => {
    ...
    expect(ponies.length).withContext('You should have one li element per pony').toBe(5);
